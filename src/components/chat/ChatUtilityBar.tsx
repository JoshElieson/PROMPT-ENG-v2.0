import { ChevronDown, Info, Settings2, X } from "lucide-react";
import {
  useCallback,
  useEffect,
  useMemo,
...
function ChatSettingsOverlay({
  ...
  const { chats, patchAgentSettings, patchWorkspaceSettings } = useChats();
  ...
  return (
    <div
      className="absolute inset-0 z-50 flex items-center justify-center p-4 animate-in fade-in-0 duration-200"
      role="presentation"
    >
      <button
        type="button"
